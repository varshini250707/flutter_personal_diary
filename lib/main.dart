...
import 'package:flutter_personal_diary/services/UiProvider.dart';
import 'package:flutter_personal_diary/Screens/HomeScreen.dart';
      ...
      child: Consumer<UiProvider>(
        builder: (context, UiProvider notifier, child) {
          return MaterialApp(
            ...
            home: HomeScreen(title: 'Personal Diary'),
